<?php
    ...
    function getAllBracelets (PDO $pdo, int $itemPerPage, int $page){ 
        $offset = (($page - 1) * $itemPerPage);

        $query = "SELECT * FROM article WHERE category=2 ORDER BY article.name ASC LIMIT $itemPerPage OFFSET $offset";
    ...
    function getAllEarrings (PDO $pdo, int $itemPerPage, int $page){ 
        $offset = (($page - 1) * $itemPerPage);

        $query = "SELECT * FROM article WHERE category=4 ORDER BY article.name ASC LIMIT $itemPerPage OFFSET $offset";
