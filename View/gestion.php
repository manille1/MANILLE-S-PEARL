...
<div id="category-choice">
    ...
    <div class="card-choice">
        <div><img src="./uploads/article.jpg" alt="boîte empiler"></div>
        <h3>Articles</h3>
    ...
    <div class="card-choice">
        <div><img src="./uploads/post-it.jpg" alt="post-it d'organisation"></div>
        <h3>Catégories</h3>
    ...
    <?php if($_SESSION['role'] === 1) { ?>
        <div class="card-choice">
            <div><img src="./uploads/users.jpg" alt="users"></div>
            <h3>Utilisateurs</h3>
